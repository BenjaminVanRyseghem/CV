...
Improve the \link{Pharo}{http://pharo.org/} IDE toolset. The SummerTalk is an \textsc{Esug} (European Smalltalk User Group) equivalent to the Google Summer of Code.
