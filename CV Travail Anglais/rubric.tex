...
%	\item[- ] Communication
%%	\item[- ] Connaissance de l'entreprise (SSII) : gestion d'entreprise, conomie, droit
%       \end{itemize}
%\end{itemize}
...
%\end{itemize}
%\entry*[2007 - 2009]
%3\textup{me} anne de Licence de Mathmatiques Pures et Appliques  l'Universit des Sciences et Technologies de Lille.
%\begin{itemize}
...
%\end{itemize}
%\entry*[2005 - 2007]
%Classe Prparatoire aux Grandes coles, Mathmatiques-Physique option Informatique aux lyces Roosevelt et Clmenceau de Reims.
%\begin{itemize}
%  \item[- ]  Gestion du stress
%  \item[- ]  Comptitivit
%  \item[- ]  Qualit de communication
%\end{itemize}
...
%\entry*[t 2011]
%Participation au SummerTalk organis par \textsc{Esug} (European Smalltalk User Group) pour le projet \emph{Tools improvement}.
%\begin{itemize}
%	\item[- ] criture de compte-rendus mensuels
%	\item[- ] Autonomie de travail
%\end{itemize}

%\entry*[01/05/2011 - 30/06/2011]
%Employ  l'\textsc{Inria}, en charge de l'amlioration des widgets et du dveloppement de nouveaux outils d'dition de code.
%\begin{itemize}
...
%Stagiaire  l'\textsc{Inria}, en charge du projet \textbf{Hazelnut} (cration dynamique de noyaux dans un langage rflexif) au sein de l'quipe \textsc{\href{http://rmod.inria.fr/}{\underline{RMoD}}}.
%\begin{itemize}
%	\item[- ] Programmation oriente objet
%	\item[- ] Rdaction de rapports techniques
...
%\entry*[2010]
%Projet tuteur : Ajout d'un plugin  Pharo, une IDE pour \textsc{SmallTalk}
%\begin{itemize}
%  \item[- ]  Sens de l'initiative.
%  \item[- ]  Travail d'quipe.
%  \item[- ]  Respect des dlais.
%  \item[- ]  Gestion d'un projet, de l'analyse au recettage.
%\end{itemize}
%\entry*[2009]
%Employ polyvalent  la SARL \textsc{What's Up} (salle d'escalade)  Villeneuve d'Ascq.
%\begin{itemize}
%  \item[- ]  Polyvalence
%  \item[- ]  Facult d'adaptation
%\end{itemize}

%\entry*[2006 - 2008]
%Libraire durant un mois, puis temps complet partag Service Dcoration/Hte de Caisse durant un mois, puis Service Dcoration durant un mois au centre \textsc{E.Leclerc} Sodirom, Romilly-sur-Seine (emploi saisonnier).
%\begin{itemize}
%  \item[- ]  Respect de chartes internes (charte graphique, quantits et dimensions des impressions).
%  \item[- ]  Crativit.
%\end{itemize}
%----------------------------------------------------------
%   CENTRES D'INTERETS
